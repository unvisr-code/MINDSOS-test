  ...
  return (
    <div className="min-h-screen bg-sage-50 pb-20">
      ...
      <div className="px-6 py-6 space-y-3">
        {mockFAQs.map((faq, index) => (
          ...
          >
            ...
            >
              <div className="w-8 h-8 bg-lavender-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
      ...
      <div className="px-6 pb-8">
        <div className="bg-gradient-to-br from-lavender-500 to-lavender-600 text-white rounded-2xl p-6">
          <h3 className="font-semibold mb-2">추가 문의가 있으신가요?</h3>
          <p className="text-sm opacity-90 mb-4">
            더 궁금하신 사항이 있다면 언제든 문의해주세요
          </p>
          <button className="bg-white text-lavender-600 px-6 py-2 rounded-xl font-medium hover:bg-lavender-50 transition-colors">
            문의하기
          </button>
        </div>
      </div>
